...
// Common properties for all collections: createdAt, updatedAt, isDeleted.
...
const baseIndexes = (prefix) => {
  return [
    {
      key: { createdAt: -1 },
      name: `streamsphere_${prefix}_createdAt_index`,
    },
    {
      key: { updatedAt: -1 },
      name: `streamsphere_${prefix}_updatedAt_index`,
    },
    {
      key: { isDeleted: -1 },
      name: `streamsphere_${prefix}_isDeleted_index`,
    },
  ];
};
